...
if (typeof packageFile.name === 'undefined') {
	console.warn( 'Package file doesn\'t exist or is not formatted correctly. Please add scripts to the package.json file manually.' );
	return;
}
...
if (typeof packageFile.scripts.watch !== 'undefined' || typeof packageFile.scripts.dev !== 'undefined' || typeof packageFile.scripts.prod !== 'undefined') {
	console.warn( 'The scripts this package requires have already been defined in your package.json file. Please override them manually if you wish.' );
	return;
}
...
console.info('Scripts added to package.json file successfully.');
